...
import grails.plugins.elasticsearch.EntityKey
import grails.plugins.elasticsearch.IndexSynchronization
 ...
 *
 * TODO Not necessary after Grails 3 upgrade?
 */
class AuditEventListener2 extends AuditEventListener {
    ...
    AuditEventListener2(Datastore datastore) {
        super(datastore)
    }
